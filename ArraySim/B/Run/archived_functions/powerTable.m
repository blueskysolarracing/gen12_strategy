function [powTab] = powerTable(array, canopy, cellSheet)
...
parfor El = 1:181 %El in row
    ...
    for Az = 1:181 %Az in col 
        ...
        %Find power output of each cell in 'sgtC' structure
        [cellIrr] = cellData(sunVector,sgtC,gtC);
            
        %Obtain combined power output of all substrings 
        totPow = totalPower(cellIrr); 
