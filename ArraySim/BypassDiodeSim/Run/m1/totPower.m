...
% @param string_config: json files describing the substring and cell layout of the array
    ...
    Slope_Vdc_string1 = 76 * 0.77;
    Slope_Vdc_string2 = 91 * 0.77;
    Slope_Vdc_string3 = 90 * 0.77;
    ...
    irr_diode_string_String1 = [irr_diode_string_String1, 0];
    irr_diode_string_String1 = flip(irr_diode_string_String1);
    ...
    irr_diode_string_String2 = [irr_diode_string_String2, 0];
    irr_diode_string_String2 = flip(irr_diode_string_String2);
    ...
    irr_diode_string_String3 = [irr_diode_string_String3, 0];
    irr_diode_string_String3 = flip(irr_diode_string_String3);
    ...
    sim('String1_Diode.slx',[],options);
    sim("String2_Diode.slx",[],options);
    sim("String3_Diode.slx",[],options);
